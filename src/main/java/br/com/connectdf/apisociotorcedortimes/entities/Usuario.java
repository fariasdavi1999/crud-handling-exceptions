...
public class Usuario implements Serializable {
	...
	public Usuario(UUID id, String nome, String nomePai, String nomeMae,
			String documentoIdentidade, String dataNascimento, String genero,
			String cpf, String dataExpedicao, String naturalidade,
			String registro, String dataValidade, String categoriaHabilitacao,
			String dataEmissao, String estadoEmissor, String orgaoEmissor,
			String documentoFrente, String documentoVerso,
			String documentoRetrato, String documentoAssinatura, String email,
			String celular, String cnpj, String nomeEsposa, String cpfEsposa,
			String emailEsposa, String celularEsposa) {
